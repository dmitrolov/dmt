...
let CharacterGeneratorSelectComponent = class CharacterGeneratorSelectComponent {
    constructor() {
...
let MainInfoComponent = class MainInfoComponent {
    constructor(store) {
        this.store = store;
...
MainInfoComponent.ctorParameters = () => [
...
let PickBackgroundComponent = class PickBackgroundComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PickClassComponent = class PickClassComponent {
    constructor(store) {
        this.store = store;
    ...
    setProficiency(character, proficiency) {
        const proficiencyAttributes = [];
...
PickClassComponent.ctorParameters = () => [
    { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"] }
];
...
let PickRaceComponent = class PickRaceComponent {
    constructor(store) {
        this.store = store;
    ...
    // }
    saveRace() {
        _models_character_racesList__WEBPACK_IMPORTED_MODULE_3__["racesList"].map((race) => {
            if (race.value === this.generatingCharacter.about.info.race) {
                ...
                console.log('this.generatingCharacter.about.description.imageUrl', this.generatingCharacter.about.description.imageUrl, 'race.generatorData.image', race.generatorData.image);
...
PickRaceComponent.ctorParameters = () => [
    { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"] }
];
...
let PlayerCharacterGeneratorComponent = class PlayerCharacterGeneratorComponent {
    constructor(store, firebaseService) {
        this.store = store;
...
PlayerCharacterGeneratorComponent.ctorParameters = () => [
    { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"] },
...
let InventoryComponent = class InventoryComponent {
    ...
    ngOnInit() {
        this.currentUser.equipment.forEach((characterItem) => {
            this.db.getItem(characterItem.value).subscribe((element) => {
...
AttributesComponent.ctorParameters = () => [
...
GeneralInfoComponent.ctorParameters = () => [
    { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"] }
];
...
let ProficiencyComponent = class ProficiencyComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PlayerCharacterPageComponent = class PlayerCharacterPageComponent {
    constructor(firebaseService, route, store) {
        this.firebaseService = firebaseService;
        this.route = route;
        this.store = store;
        this.menuOptions = {
    ...
    ngOnInit() {
        this.route.url
            ...
            this.firebaseService
                ...
                this.store.dispatch(new _store_characters_characters_actions__WEBPACK_IMPORTED_MODULE_4__["SetCharacter"](item));
            });
        });
    }
};
PlayerCharacterPageComponent.ctorParameters = () => [
...
const GET_CHARACTER = '[Character] Get';
const GET_DEFAULT_CHARACTER = '[Character] Get Default';
const ADD_CHARACTER = '[Character] Add';
const SET_CHARACTER = '[Character] Set';
...
/* harmony import */ var _characters_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./characters.actions */ "./src/app/store/characters/characters.actions.ts");
...
function characterReducer(state = defaultState, action) {
    ...
    switch (action.type) {
        case _characters_actions__WEBPACK_IMPORTED_MODULE_0__["GET_CHARACTER"]:
            return state;
        case _characters_actions__WEBPACK_IMPORTED_MODULE_0__["GET_DEFAULT_CHARACTER"]:
            return defaultState;
        case _characters_actions__WEBPACK_IMPORTED_MODULE_0__["SET_CHARACTER"]:
            return Object.assign({}, defaultState, state, action.character);
        default:
            return state;
    }
}
